...
// Интерфейс для обработчика цепочки
...
// Абстрактный класс для обработчика цепочки
...
// Обработчик для извлечения заголовков из входного потока
...
// Обработчик для извлечения метода из заголовков
...
// Обработчик для извлечения пути из заголовков
...
// Обработчик для извлечения сессии из заголовков
...
// Сервис для выполнения цепочки обработчиков
class ChainService {
